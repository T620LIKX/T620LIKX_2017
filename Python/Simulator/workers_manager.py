...
class WorkersManager:
    ...
    def create_worker(self, settings, index):
        ...
        if settings.workers_details:
            if 'breaks' in settings.workers_details[index].keys():
                for b in settings.workers_details[index]['breaks']:
                    w['breaks'].enqueue( b )

            w['shift start'] = settings.workers_details[index]['shift_start']
            w['shift end'] = settings.workers_details[index]['shift_end']
        else:
